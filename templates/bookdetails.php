...
$query11 = "select book from books where m_id='{$_GET['m_id']}'";
...
$cl=$_GET['m_id'];
if(isset($_POST['del'])){
    $q1="delete from books where m_id='$cl'";
    mysqli_query($con, $q1);
...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-item">
        <a href="books.php" class="nav-link text-dark bg-light">
    ...
    <div class="col-lg-12">
      ...
      <div class="container">
        <div class="pdf">
          ...
          <embed type="application/pdf" src="<?php if (isset($book)) echo $book; ?>" width="800px" height="600px">
        </div>
        <form method="post" style="display: <?php if ($id == "Teacher") {
                    echo "block";
                  } else echo "none";?>">
            <input class="btn btn-primary" type="submit" value="Delete this book" name="del"></input>
        </form>
      </div>
    </div>
